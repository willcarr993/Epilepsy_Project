...
DrawFormattedText(window,'Press Button 1 for Old, Button 2 for Similar, Button 3 for New.\n\nPress the Button 1 when you are ready to begin.','center','center',BlackIndex(window));
